...
LOCAL_ROOT_PATH="/Users/REPLACE_ME/Sites/franu-edu/"
...
LOCAL_BACKUPS_PATH="/Users/REPLACE_ME/Sites/franu-edu/backups/"

# -- REMOTE settings --

# Remote ssh credentials, user@domain.com and Remote SSH Port
REMOTE_SSH_LOGIN="franu@104.237.136.88"
REMOTE_SSH_PORT="22"

# Remote path constants; paths should always have a trailing /
REMOTE_ROOT_PATH="/srv/users/franu/apps/franu-dev/"
REMOTE_ASSETS_PATH=${REMOTE_ROOT_PATH}"shared/assets/"

# Remote database constants
REMOTE_DB_NAME="franu"
...
REMOTE_BACKUPS_PATH="/srv/users/franu/apps/franu-dev/backups/"

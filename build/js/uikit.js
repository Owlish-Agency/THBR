...
(function (global, factory) {
    ...
    */
    ...
    var Grid = {
        ...
        update: [{
            ...
            write: function write(ref) {
                ...
                css(this.$el, 'paddingBottom', this.parallax && rows.some(function (row) {
                    return row.length > 1;
                }) ? this.parallax : '');
            ...
            read: function read(ref) {
                ...
                return {
                    scrolled: this.parallax && rows.some(function (row) {
                        return row.length > 1;
    ...
    var Img = {
        ...
        update: [{
            ...
            read: function read(ref) {
                ...
                if (image || !this.loaded && this.isImg || storage[this.cacheKey] && this.isImg || !this.target.some(function (el) {
    ...
    var Navbar = {
        ...
        methods: {
            ...
            transitionTo: function transitionTo(newHeight, el) {
                ...
                return Transition.start([el, dropbar], { height: newHeight }, this.duration).catch(noop).then(function () {
            ...
            animate: function animate$$1(action) {
                ...
                return new Promise(function (resolve) {
                    ...
                    this$1._raf = requestAnimationFrame(function () {
                        ...
                        children = children.concat(toNodes(this$1.target.children).filter(function (el) {
    ...
    function Transitioner$1(prev, next, dir, ref) {
        ...
        var from = prev ? getLeft(prev, list, center) : getLeft(next, list, center) + next.offsetWidth * dir;
        var to = next ? getLeft(next, list, center) : from + prev.offsetWidth * dir * (isRtl ? -1 : 1);
        ...
        return {
            ...
            translate: function translate$1(percent) {
                ...
                css(list, 'transform', translate(clamp(-to + (distance - distance * percent), -getWidth(list), list.offsetWidth) * (isRtl ? -1 : 1), 'px'));

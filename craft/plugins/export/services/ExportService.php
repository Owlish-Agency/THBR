        ...
        if (!is_null($data)) {
            ...
            if (!is_null($field)) {
                ...
                switch ($field->type) {
                    ...
                    /*
                        Removed and used below for Volunteer Section
                    */
                    ...
                    case ExportModel::FieldTypeMultiSelect:
                        ...
                        break;
                    /*
                        Setup to work with Volunteer Section
                    */
                    case ExportModel::FieldTypeDate:
                        if ($field['handle'] == 'startTime') {
                            $data = (string) $data->format('g:i a');
                            break;
                        } elseif ($field['handle'] == 'endTime') {
                            $data = (string) $data->format('g:i a');
                            break;
                        } elseif ($field['handle'] == 'volunteerDate') {
                            $data = (string) $data;
                            break;
                        } else {
                            $data = (string) $data;
